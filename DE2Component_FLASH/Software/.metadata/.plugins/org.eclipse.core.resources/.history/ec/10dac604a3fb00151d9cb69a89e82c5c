...
#define USB_HID_DESCRIPTOR_TYPE					  0x22
...
typedef struct _USB_CONFIGURATION_DESCRIPTOR_a {
    ...
    //HID Descriptor
    UCHAR bLength_HID_key;
    UCHAR bDescriptorType_HID_key;
    UCHAR bcdHID_key_L;
    UCHAR bcdHID_key_H;
...
typedef struct _USB_HID_DESCRIPTOR {
	UCHAR 	bLength;			// Valid length in bytes
	UCHAR 	bDescriptorType;	// 0x21 for HID
	UCHAR	wbcdHID_L;				// Version of HID device is compliant with
	UCHAR	wbcdHID_H;
	UCHAR	bCountryCode;		// Set to zero for no specific localization
	UCHAR 	bNumDescriptors;	// Number of descriptor children
	UCHAR 	bNextDescriptorType;	//
	UCHAR	wDescriptorLength_L;	// Length of report descriptor
	UCHAR	wDescriptorLength_H;	// Length of report descriptor
