...
(
    ...
    localparam PAD10 = log2ceil(64'h1909068 - 64'h1909060); 
    localparam PAD11 = log2ceil(64'h1909070 - 64'h1909068); 
    localparam PAD12 = log2ceil(64'h1909078 - 64'h1909070); 
    // -------------------------------------------------------
    // Work out which address bits are significant based on the
    // address range of the slaves. If the required width is too
    // large or too small, we use the address field width instead.
    // -------------------------------------------------------
    localparam ADDR_RANGE = 64'h1909078;
    ...
    // ( 0x1909068 .. 0x1909070 )
    if ( {address[RG:PAD11],{PAD11{1'b0}}} == 25'h1909068   ) begin
            src_channel = 13'b0000001000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 10;
    end

    // ( 0x1909070 .. 0x1909078 )
    if ( {address[RG:PAD12],{PAD12{1'b0}}} == 25'h1909070   ) begin
