...
module niosII_system_tristate_conduit_bridge_0 (
    ...
    ,input  logic[ 0 :0 ] tcs_generic_tristate_controller_0_tcm_byteenable_out
    ,output  wire [ 0 :0 ] generic_tristate_controller_0_tcm_byteenable_out
    ,input  logic[ 0 :0 ] tcs_generic_tristate_controller_0_tcm_begintransfer_out
    ,output  wire [ 0 :0 ] generic_tristate_controller_0_tcm_begintransfer_out
 ...
 // ** Output Pin generic_tristate_controller_0_tcm_byteenable_out 
 
    reg                       generic_tristate_controller_0_tcm_byteenable_outen_reg;     
  
    always@(posedge clk) begin
	 if( reset ) begin
	   generic_tristate_controller_0_tcm_byteenable_outen_reg <= 'b0;
	 end
	 else begin
	   generic_tristate_controller_0_tcm_byteenable_outen_reg <= 'b1;
	 end
     end		     
   
 
    reg [ 0 : 0 ] generic_tristate_controller_0_tcm_byteenable_out_reg;   

     always@(posedge clk) begin
	 generic_tristate_controller_0_tcm_byteenable_out_reg   <= tcs_generic_tristate_controller_0_tcm_byteenable_out[ 0 : 0 ];
      end
          
 
    assign 	generic_tristate_controller_0_tcm_byteenable_out[ 0 : 0 ] = generic_tristate_controller_0_tcm_byteenable_outen_reg ? generic_tristate_controller_0_tcm_byteenable_out_reg : 'z ;
        


 // ** Output Pin generic_tristate_controller_0_tcm_begintransfer_out 
 
    reg                       generic_tristate_controller_0_tcm_begintransfer_outen_reg;     
  
    always@(posedge clk) begin
	 if( reset ) begin
	   generic_tristate_controller_0_tcm_begintransfer_outen_reg <= 'b0;
	 end
	 else begin
	   generic_tristate_controller_0_tcm_begintransfer_outen_reg <= 'b1;
	 end
     end		     
   
 
    reg [ 0 : 0 ] generic_tristate_controller_0_tcm_begintransfer_out_reg;   

     always@(posedge clk) begin
	 generic_tristate_controller_0_tcm_begintransfer_out_reg   <= tcs_generic_tristate_controller_0_tcm_begintransfer_out[ 0 : 0 ];
      end
          
 
    assign 	generic_tristate_controller_0_tcm_begintransfer_out[ 0 : 0 ] = generic_tristate_controller_0_tcm_begintransfer_outen_reg ? generic_tristate_controller_0_tcm_begintransfer_out_reg : 'z ;
